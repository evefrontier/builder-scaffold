...
1. **Setup your local development environment** set up a containarised environement with sui tools for local developement in local
2. **Deploy an EVE Frontier world** and create test resources for developement.
